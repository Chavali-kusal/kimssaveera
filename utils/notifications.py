...
def queue_doctor_registration_message(doctor_phone: str, provider_name: str = "msg91", channel: str = "SMS"):
    doctor_phone = _clean(doctor_phone)
    if not doctor_phone:
        return
    now = _now()
...
def queue_doctor_approved_message(doctor_phone: str, provider_name: str = "msg91", channel: str = "SMS"):
    doctor_phone = _clean(doctor_phone)
    if not doctor_phone:
        return
    now = _now()
...
def queue_referral_paid_message(lead_id: int, doctor_phone: str, patient_name: str, provider_name: str = "msg91", channel: str = "SMS"):
    doctor_phone = _clean(doctor_phone)
    patient_name = _clean(patient_name)
    if not doctor_phone:
        return
